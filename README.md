...
> npm registry note: `@labacacia/nps-sdk@1.0.0-alpha.11` was deprecated because its published tarball omitted `dist/`. That is fixed in `1.0.0-alpha.12` — install `@labacacia/nps-sdk@alpha` (the `alpha` dist-tag now resolves to `1.0.0-alpha.12`).
